...
- Watch repeated patterns: parallel lists (three items still count), concession rhythm (`not X, but Y`), identical paragraph arcs. Break where they dominate.
...
- Cut, don't add. Em dashes are fine; repeating them per paragraph isn't. No fake humanity. Don't strip structure for style.
